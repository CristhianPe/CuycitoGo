    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (!snap.empty) {
                ...
                const newLoginCount = (parseInt(currentData.loginCount) || 0) + 1;
                ...
                // Registrar en sessionStorage que este login ya fue computado
                sessionStorage.setItem("cuycito_client_session_counted_" + docId, "true");
