...
try {
    onSnapshot(doc(db, "system_config", "store_settings"), (docSnap) => {
        ...
        if (docSnap.exists() && docSnap.data().maintenanceMode === true) {
            ...
            if (alertBox) {
                alertBox.innerText = '⚠️ El acceso por medio de login se encuentra pausado temporalmente por mantenimiento técnico. Por favor espera a que se restablezca el servicio.';
